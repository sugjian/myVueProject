  ...
  <div>
    ...
    <footer>
       <div class="van-hairline--top-bottom van-tabbar van-tabbar--fixed" style="z-index: 1;">
          <div class="van-tabbar-item van-tabbar-item--active" @click="yewuyuan"><div class="van-tabbar-item__text">业务员</div></div>
  ...
  export default {
    ...
    methods: {
     ...
     init(){
      ...
      yewuyuan(){
        this.$router.push({name:'shichangbujingli_yewuyuan'});
      },
      onActConfirm() {
        if(!this.xuhao){
          Toast.failed('请输入序号！'); 
         ...
         let param={
          ...
          type:this.type,
          beizhu:this.beizhu,
          // baobeiid:getStore('userid')
          };
         util.post('add_kehu',param,function(datas2){
            Toast.succeed('添加成功！');
