...
<script>
  ...
  export default {
    ...
    methods: {
     ...
     init(){
        const that=this;
        util.post('kehu_list',{userid:this.$route.query.id,datype:this.datype,xiaotype:this.xiaotype,searchk:this.searchk,searchj:this.searchj,searchf:this.searchf},function(datas2){
      ...
      xiangqing(detail){
         this.$router.push({name:'kehu',query:{id:detail.id}});     
      },
      sheji(){
        this.$router.push({name:'dianzhang_sheji_view',query:{id:this.$route.query.id}});     
      },
      shichang(){
        this.$router.push({name:'dianzhang_shichang_view',query:{id:this.$route.query.id}});     
      },
      wode(){
