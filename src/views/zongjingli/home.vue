  ...
  <div>
    ...
    <footer>
       <div class="van-hairline--top-bottom van-tabbar van-tabbar--fixed" style="z-index: 1;">
          <div class="van-tabbar-item van-tabbar-item--active" @click="mendian"><div class="van-tabbar-item__text">门店</div></div>
     ...
     init(){
      ...
      mendian(){
         if(getStore('usertype')=='1'){
           this.$router.push({name:'zongjingli_mendian'});
         }else{
           this.$router.push({name:'zongjingban_mendian'});
         }       
      },
      xiangqing(detail){
