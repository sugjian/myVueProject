<template>
  <div>
    <header>
        ...
        <div class="rightcss" @click="tianjia()" v-show="isShow">
    ...
    <md-dialog
      title="添加"
      :closable="true"
      v-model="actDialog2.open"
      :btns="actDialog2.btns"
    >
      <md-field>
        <md-field-item
          name="name"
  ...
  export default {
    ...
    methods: {
      init(){
        ...
        util.post('mendianlist',{},function(datas2){
      ...
      chakan(){
        this.$router.push({name:'dianzhang_home_view',query:{id:this.curdetail.id}});    
      },
      showSelector() {
